    ...
    public partial class UserExcelExportForm : UserControl
    {
        ...
        private async void excelSheetGrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    bool success = await SheetSyncAsync(sheetName, type);
                ...
                {
                    var result = MessageBox.Show(this, "We are not deleting Sheet just Sync Data", "Delete Sync Sheet",
        ...
        private void excelSheetGrid_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            Image icon = type.Equals("json", StringComparison.OrdinalIgnoreCase)
                ? Properties.Resources.AppIcon : Properties.Resources.excel_icon;
        ...
        private bool IsDeleteDisabled(int rowIndex)
        {
            ...
            var uploadedValue = excelSheetGrid.Rows[rowIndex].Cells["sheetUploaded"].Value;
            bool isUploaded = uploadedValue != null && (bool)uploadedValue;
            ...
            bool isRestrictedSheet = sheetName.Equals("Cost.Cal", StringComparison.OrdinalIgnoreCase) &&
                                     type.Equals("json", StringComparison.OrdinalIgnoreCase);

            return isRestrictedSheet;
        }
        #endregion
        ...
        #region Sheet Sync
        public async Task<bool> SheetSyncAsync(string sheetName, string type)
        {
            ...
            try
            {
                ...
                isSuccess = base64Result;

                SplashManager.Hide();
                BringAppToFront();
                MessageBox.Show(this, base64Result ? "Sheet synced successfully." : "Failed to sync sheet.",
