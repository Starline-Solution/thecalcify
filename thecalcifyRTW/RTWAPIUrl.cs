...
namespace thecalcifyRTW
{
    public static class RTWAPIUrl
    {
        ...
        public static string LocalUrl => "http://192.168.3.84:1122/excel?user=thecalcify&auth=Starline@1008&type=Desktop";
        public static string UATUrl => "http://35.176.5.121:1008/excel?user=thecalcify&auth=Starline@1008&type=Desktop";
